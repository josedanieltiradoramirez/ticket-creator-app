...
async def create_queue(user : user_dependency, queue: TicketCreate, db: db_dependency):
...
async def edit_queue(user: user_dependency, id: int, queue: TicketUpdate, db: db_dependency):
