...
async def create_troubleshooting_template(user : user_dependency, troubleshooting_template: TicketCreate, db: db_dependency):
...
async def edit_troubleshooting_template(user: user_dependency, id: int, troubleshooting_template: TicketUpdate, db: db_dependency):
